...
Although, I believe that guidelines are made to be extended. Extending Sass Guidelines could be as simple as having a document stating that the code is following the guidelines from these guidelines except for a few things; in which case, specific rules would be explained below.
